  ...
  return (
    <div className='text_container'>
      ...
      <ol>
        ...
        <p>ScoutVendor Net SRL nad ScoutVendor are commited to ensuring that your privacy is protected. If we ask you to provide certain information by which you can be identified when using this website, we garantee that it will be used in accordance to this Privacy statement.</p>
        <p>Our site is not targeted for use by anyone under the age of 18. By using this website, you warrant that you are at least 18 years old. We reserve the right to terminate your membership if any information may lead us to discover the fact that you are less that 18.</p>
        <p>Persons under 18 may not submit any personally identifiable information on the Website and if it is discoverd that such information has been inadvertently gathered, we reserve the right to delete it.</p>
        <p>Scout Vendor uses the information voluntarily submitted by users in order to enhance their experience on its network of sites, to provide interactice or personalised elements or to deliver preference-based content to the users.</p>
        
        <li>Cookies and Gathering User Technical Data</li>
        ...
        <ul>
            <li>When you visit ScoutVendor, we collect your IP address, such as your browser type and the pages you have accessed on our website. This information will be collected and saved our Net SRL.</li>
        ...
        <p>At the present time it is not technically possible for us to allow you to carry your cookie settings with you between your browsers and devices so you will need to change these settings from each browser you use.</p>
        ...
        <p>We do not sell, trade, or otherwise transfer your personally identifiable information to third parties. This does not include trusted third parties who assist us in operating our website, conducting our business, or providing you with services, as long as those parties are committed to keeping this information confidential by all means. We may also release your information when such a release is necessary in order to comply with the law, enforce our site policies or protect the rights, property or safety of ScoutVendor Net SRL or of other parties. However, non-personally identifiable visitor information may be provided to other parties for marketing and advertising purposes or for other uses.</p>
        <li>Data Security</li>
        <p>We are committed to ensuring that your information is secure. In order to prevent unauthorized access or disclosure, we use advanced physical, electronic and managerial procedures to safeguard and secure the information that we collect online.</p>
        <li>External Links</li>
        <p>The site may contain links, ads or advertising banners that will lead you to other sites, belonging to third parties. Any kind of information, including personal information, given to such pages is not under ScoutVendor Net SRL’s jurisdiction or authority, and this company cannot be held responsible for any usage of these sites. If you have concerns about how other web sites collect and use your personal information, make sure to read that site's own privacy policy. ScoutVendor is not responsible for the privacy practices or for the content of these sites. Nonetheless, we seek to protect the integrity of our site and welcome any feedback about these sites</p>
      </ol>
    </div>
  )
}
